...
the :ref:`O-RAN 7.2 Guide <oran_ru_tutorial>`. 
...
information regarding stable firmware versions, drivers, configuration files and other hardware specific information. 
Questions relating to hardware specific issues should be directed to the manufacturer of that hardware. 
