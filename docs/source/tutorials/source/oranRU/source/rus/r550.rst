...
- :download:`2x2 MIMO configuration with 20 MHz bandwidth <.configs/gnb_ru_ran550_tdd_n78_20mhz_2x2.yml>`.
- `4x2 MIMO configuration with 100 MHz bandwidth <https://github.com/srsran/srsRAN_Project/blob/main/configs/gnb_ru_ran550_tdd_n78_100mhz_4x2.yml>`_
...
- :download:`2x2 MIMO configuration with 20 MHz bandwidth  <.configs/ru_config_20.cfg>`.
- :download:`4x2 MIMO configuration with 100 MHz bandwidth <.configs/ru_config.cfg>`.

In the case of using the 2x2 MIMO configuration with 20 MHz bandwith, the Msg1 offset needs to be manually set by writing to the ``0xc0324`` register. It can be done by writing the following command in the RU control console:
...
- :download:`RF configuration (2x2 MIMO configuration with 20 MHz bandwidth)  <.configs/rf_config_amariUE_R550_20mhz_2x2.cfg>`.
